...
public class OrdersGenerator {
    ...
    public void generate() {
        ...
        for (int i = 0; i < 1500000; i++) {
            ...
            int productOrKit = new Random().nextInt(6);

            int categoryNumber = faker.number().numberBetween(1, 14);
            int productId = 0;
            switch (categoryNumber) {
                case 1:
                    productId = faker.number().numberBetween(1, 75000);
                    break;
                case 2:
                    productId = faker.number().numberBetween(1, 1000000);
                    break;
                case 3:
                    productId = faker.number().numberBetween(1, 50000);
                    break;
                case 4:
                    productId = faker.number().numberBetween(1, 4249664);
                    break;
                case 5:
                    productId = faker.number().numberBetween(1, 75000);
                    break;
                ...
                case 7:
                    ...
                    break;
                case 8:
                    productId = faker.number().numberBetween(1,2649785);
                    break;
                case 9:
                    productId = faker.number().numberBetween(1, 75000);
                    break;
                case 10:
                    productId = faker.number().numberBetween(1, 99996);
                    break;
                case 11:
                    productId = faker.number().numberBetween(1, 75000);
                    break;
